...
// Read Database
global.db = JSON.parse(fs.readFileSync('./alliance/src/database.json'))
...
sendOrder(m.chat, teks, "391028153034238", fs.readFileSync('./alliance/media/image/Deff.jpg'), 2022, "DAISUKE-BOTZ-MD", "6289501060783@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
setInterval(() => {
fs.writeFileSync('./alliance/src/database.json', JSON.stringify(global.db, null, 2))
}, 60 * 1000)
...
"title": "𝑫𝑨𝑰𝑺𝑼𝑲𝑬-𝑩𝑶𝑻𝒁", //Kasih namalu 
"description": "SELF BOT", 
"currencyCode": "USD",
"priceAmount1000": "2000",
"retailerId": "Dhaff Official",
"productImageCount": 1
},
...
status: 1,
surface : 1,
message: '𝑫𝑨𝑰𝑺𝑼𝑲𝑬-𝑩𝑶𝑻𝒁', //Kasih namalu
orderTitle: 'Bang',
...
key: { 
fromMe: false,
participant: `6285797226828@s.whatsapp.net`, ...(from ? 
{ remoteJid: "6289643739077-1613049930@g.us" } : {}) 
},
message: { 
"audioMessage": {
...
${headtqto}
${awalbranch}ALLAH SWT
${B}NABI MUHAMMAD SAW
${A}ORTU
${B}Dika Ardnt my lord
${A}ZackMans my lord
${B}Rifza my lord
${A}Deff my lord
${branch}DHAFF OFC Its Me
${left} ${ucapanWaktu}
${branch} ${jangwak}
${akhiranbranch}
${end}`
...
const getCase = (cases) => {
return "case"+`'${cases}'`+fs.readFileSync("alliance/command.js").toString().split('case \''+cases+'\'')[1].split("break")[0]+"break"
}
m.reply(`${getCase(q)}`)
break
case 'menu': case 'help': {
if (isBan) return m.reply(mess.ban)
let message = await prepareWAMessageMedia({ video: fs.readFileSync('./alliance/media/video/Deff.mp4'), gifPlayback:true, jpegThumbnail:global.log0 }, { upload: sock.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
videoMessage: message.videoMessage,
hydratedContentText: listmn,
hydratedFooterText: "© DAISUKE-BOTZ-MD",
hydratedButtons: [{
urlButton: {
...
url: 'https://instagram.com/dhaffnavyz'
}
}, {
quickReplyButton: {
...
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/menu.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
//audio bales chat vn
case 'assalamualaikum': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/salam.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'yangbener': case 'bohong': case 'boong': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/bohong.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'ngetes': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/ngetes.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'buatapa': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/buatapa.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'araara': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/araara.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'ngetes': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/ngetes.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
...
break
case 'males': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/males.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'anjing': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/anjing.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'mastah': case 'adamastah': case 'lariadamastah': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/mastah.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
case 'textmaker': {
if (isBan) return m.reply(mess.ban)
...
break
case 'asalamualaikum': case 'Asalamualaikum': {
sock.sendMessage(m.chat, {audio:  fs.readFileSync('./alliance/media/audio/salam.mp3'), mimetype: 'audio/mp4', ptt:true}, {quoted:m})
}
break
...
let { genMath, modes } = require('./alliance/src/math')
...
case 'listmsg': {
if (isBan) return m.reply(mess.ban)
let msgs = JSON.parse(fs.readFileSync('./alliance/src/database.json'))
...
url: 'https://github.com/Dhaffnavy/'
}
}, {
urlButton: {
displayText: 'Group Whatsapp',
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© DAISUKE-BOTZ-MD", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© DAISUKE-BOTZ-MD", log0, btn, thum)
}
...
jpegThumbnail: log0,
caption: teks,
footer: "©DHAFF OFFICIAL",
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title:"DAISUKE-MD ( Donate )",
body: "©DHAFF OFFICIAL", 
thumbnail: fs.readFileSync("alliance/media/image/donate.jpg"),
mediaType:1,
mediaUrl: 'https://telegra.ph/file/502f63401cf9725108cb8.jpg',
sourceUrl: "https://telegra.ph/file/502f63401cf9725108cb8.jpg"
}}
}
sock.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./alliance/media/image/Deff.jpg'), 2022, "DAISUKE-BOTZ-MD", "6289501060783@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await sock.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
.on('exit', () => {
sock.sendMessage(from, {image:fs.readFileSync('./alliance/storage/hasilnulis.jpg'), caption:'Succes'}, {quoted:m}).catch(() => m.reply('```「 GAGAL 」Terjadi kesalahan dalam mengirim file```'))
})
exec(`npm i marker`)
}
break
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"DAISUKE-BOTZ BY DHAFF",
body:"© DAISUKE-BOTZ-MD",
thumbnail: log0,
mediaType:2,
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Dhaff Official ~ Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Dhaff Official ~ Facebook Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Dhaff Official ~ Tiktok Downloader",
body:res.title,
thumbnail: log0,
mediaType:1,
mediaUrl: args[0],
...
if (!m.isGroup) return
if (m.key.fromMe) return
sendNye = fs.readFileSync('alliance/storage/sticker/jantag.webp')
